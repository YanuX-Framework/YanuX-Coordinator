...
async function testFeathersCoordinator() {
    ...
    //     clientId
    // ]);
    // const coordinator: FeathersCoordinator = new FeathersCoordinator(brokerUrl, localDeviceUrl, clientId, credentials, new LocalStorage('./data/localstorage'));
    ...
    const coordinator = new SimpleFeathersCoordinator(
        ...
        'react-native-coordinator',
        credentials,
        new LocalStorage('./data/localstorage')
    );
